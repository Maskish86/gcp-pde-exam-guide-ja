...
## 連携
- [[Storage/BigQuery|BigQuery]]: テーブル、データセット、ポリシータグ。
- [[Cloud-Storage|Cloud Storage]]: レイク向けのファイルセットメタデータ。
- [[Governance/Dataplex|Dataplex]]: スケール化したカタログとガバナンス。
- [[Security/IAM|IAM]]: メタデータの閲覧・編集権を制御。
